...
import 'package:myflutterapp/flutter_maps/quakes_map_app/network/network.dart';
...
class _QuakesAppState extends State<QuakesApp> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        children: <Widget>[_buildGoogleMap(context), _zoomMinus(), _zoomPlus()],
      ),
    ...
    return Container(
      ...
      child: GoogleMap(
          ...
          initialCameraPosition: CameraPosition(
              target: LatLng(36.1083333, -117.8608333), zoom: 3.0),
